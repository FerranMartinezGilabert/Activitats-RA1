...
fun main() {
    ...
    var numPupitres1 : Int = (alumnesAula1 / 2 % 2) + (alumnesAula1 / 2 % 2)
    var numPupitres2 : Int = (alumnesAula2 / 2 % 2) + (alumnesAula2 / 2 % 2)
    var numPupitres3 : Int = (alumnesAula3 / 2 % 2) + (alumnesAula3 / 2 % 2)
